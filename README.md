...
Ветка **docs** содержит sql-скрипты: **Start.sql** - создание таблиц, вставка записей, проверка корректности работы, **requests.sql** - 15 запросов, **view.sql** - представления    
...
INSERT INTO st.orders (customer_id, order_date, total_amount, shipping_address, payment_method, delivery_date) VALUES
    ...
    (11, '2024-02-24 19:00:00', 839.96, '321 Elm St, Chicago', 'paypal', '2024-02-28'), 
    ...
    (15, '2024-03-12 14:45:00', 439.97, '987 Cedar St, San Francisco', 'card', '2024-03-16'),
 ...
 INSERT INTO st.order_status_history (order_id, status, changed_at, comment, valid_to, is_current) VALUES
    -- Заказ 1: полный цикл (created → paid → processing → shipped → delivered)
    (1, 'created', '2024-02-01 10:15:00', 'Заказ создан клиентом', '2024-02-01 10:20:00', false),
    (1, 'paid', '2024-02-01 10:20:00', 'Оплата прошла успешно (карта)', '2024-02-02 09:00:00', false),
    (1, 'processing', '2024-02-02 09:00:00', 'Заказ передан в сборку', '2024-02-03 14:00:00', false),
    (1, 'shipped', '2024-02-03 14:00:00', 'Заказ отправлен курьерской службой', '2024-02-05 15:30:00', false),
    (1, 'delivered', '2024-02-05 15:30:00', 'Заказ доставлен получателю', NULL, true),
    
    -- Заказ 2: created → paid → processing → delivered
    (2, 'created', '2024-02-15 14:30:00', 'Заказ создан', '2024-02-15 14:35:00', false),
    (2, 'paid', '2024-02-15 14:35:00', 'Оплата через PayPal', '2024-02-16 10:00:00', false),
    (2, 'processing', '2024-02-16 10:00:00', 'Начата сборка заказа', '2024-02-19 16:00:00', false),
    (2, 'delivered', '2024-02-19 16:00:00', 'Доставлен курьером', NULL, true),
    
    -- Заказ 3: created → paid → processing → shipped → delivered
    (3, 'created', '2024-02-03 09:20:00', 'Заказ оформлен', '2024-02-03 09:25:00', false),
    (3, 'paid', '2024-02-03 09:25:00', 'Оплата картой', '2024-02-04 11:00:00', false),
    (3, 'processing', '2024-02-04 11:00:00', 'Сборка заказа начата', '2024-02-06 13:00:00', false),
    (3, 'shipped', '2024-02-06 13:00:00', 'Отправлен транспортной компанией', '2024-02-07 18:00:00', false),
    (3, 'delivered', '2024-02-07 18:00:00', 'Доставлен в пункт выдачи', NULL, true),
    
    -- Заказ 4: created → paid → processing → shipped → delivered
    (4, 'created', '2024-02-20 16:45:00', 'Заказ создан', '2024-02-20 16:50:00', false),
    (4, 'paid', '2024-02-20 16:50:00', 'Оплата через PayPal', '2024-02-21 09:00:00', false),
    (4, 'processing', '2024-02-21 09:00:00', 'Передан в обработку', '2024-02-23 15:00:00', false),
    (4, 'shipped', '2024-02-23 15:00:00', 'Отправлен', '2024-02-24 12:00:00', false),
    (4, 'delivered', '2024-02-24 12:00:00', 'Доставлен', NULL, true),
    
    -- Заказ 5: created → paid → processing → cancelled (отмена после оплаты)
    (5, 'created', '2024-02-05 11:00:00', 'Заказ оформлен', '2024-02-05 11:05:00', false),
    (5, 'paid', '2024-02-05 11:05:00', 'Оплата картой', '2024-02-06 10:00:00', false),
    (5, 'processing', '2024-02-06 10:00:00', 'Начата сборка', '2024-02-07 09:30:00', false),
    (5, 'cancelled', '2024-02-07 09:30:00', 'Заказ отменен по запросу клиента', NULL, true),
    
    -- Заказ 6: created → cancelled (отмена до оплаты)
    (6, 'created', '2024-02-25 13:15:00', 'Заказ создан', '2024-02-25 13:20:00', false),
    (6, 'cancelled', '2024-02-25 13:20:00', 'Отменен клиентом (передумал)', NULL, true),
    
    -- Заказ 7: created → paid → processing → shipped → delivered
    (7, 'created', '2024-02-07 08:30:00', 'Заказ создан', '2024-02-07 08:35:00', false),
    (7, 'paid', '2024-02-07 08:35:00', 'Оплата картой', '2024-02-08 10:00:00', false),
    (7, 'processing', '2024-02-08 10:00:00', 'Сборка заказа', '2024-02-10 12:00:00', false),
    (7, 'shipped', '2024-02-10 12:00:00', 'Отправлен', '2024-02-11 16:30:00', false),
    (7, 'delivered', '2024-02-11 16:30:00', 'Доставлен', NULL, true),
    
    -- Заказ 8: created → paid → shipped (сборка пропущена) → delivered
    (8, 'created', '2024-03-01 17:00:00', 'Заказ создан', '2024-03-01 17:05:00', false),
    (8, 'paid', '2024-03-01 17:05:00', 'Оплата наличными', '2024-03-02 09:00:00', false),
    (8, 'shipped', '2024-03-02 09:00:00', 'Передан в доставку', '2024-03-05 14:00:00', false),
    (8, 'delivered', '2024-03-05 14:00:00', 'Доставлен', NULL, true);
